                    ...
                    <div class="ps-lg-3">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-4 col-6">
                                ...
                                <select id="variant" wire:model="selectedVariant" class="form-select border border-secondary"
                                    style="height: 35px;">
                            ...
                            <div class="col-md-4 col-6">
                                ...
                                <select name="category" id="category" class="form-select border border-secondary"
                                    style="height: 35px;">
                        ...
                        <a href="/cart" class="btn btn-primary shadow-0"> <i class="me-1 fa fa-shopping-basket"></i>
                            Add to cart </a>
