...
@section('content')
    <div class="container">
        <div class="card">
            ...
            @endif
            <div class="card-body">
                <form action="{{ route('admin.bookkeeping.store') }}" method="POST">
                    @csrf
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="title" name="title"
                            placeholder="Judul Pembukan" required value="{{ old('title') }}">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" id="amount" name="amount" required
                            value="{{ old('amount') }}" placeholder="Jumlah Nominal">
                    </div>
                    <button type="submit" class="btn btn-primary">Buat Pembukuan</button>
                </form>
            </div>
        </div>
    </div>
