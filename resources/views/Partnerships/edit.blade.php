                ...
                <form action="{{ route('admin.partnership.update', $partnershipEdit) }}" method="POST"
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="partnership_name" name="partnership_name"
                            placeholder="Partnership Name" required value="{{ $partnershipEdit->partnership_name }}">
                    </div>
                    <div class="mb-3">
                        <label for="description" class="form-label">Deskripsi</label>
                        <textarea class="form-control" id="description" rows="3" name="description" required>{{ $partnershipEdit->description }}</textarea>
                    </div>
                    <div class="mb-3">
                        <label for="url" class="form-label">Link Partnership</label>
                        <input type="url" class="form-control" id="url" name="url"
                            value="{{ $partnershipEdit->url }}" required>
                    </div>
                    <div class="mb-3">
                        <label for="phone_number" class="form-label">Nomor Telepon</label>
                        <input type="text" class="form-control" id="phone_number" name="phone_number"
                            placeholder="Nomor Telepon" required value="{{ $partnershipEdit->phone_number }}">
                    </div>
                    <div class="mb-3">
                    ...
                    <button type="submit" class="btn btn-primary">Edit Partnership</button>
                </form>
            </div>
        </div>
    </div>
