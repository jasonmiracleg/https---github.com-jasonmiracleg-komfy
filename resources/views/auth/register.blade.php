...
@section('content')
    <div class="container pt-5">
        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header fw-bold text-white" style="background-color: #ffb348">{{ __('Register') }}</div>
    ...
    <script>
        function previewImage() {
            const image = document.querySelector('#profile_picture'); // Getting the id
